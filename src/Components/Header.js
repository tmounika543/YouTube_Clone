...
export default function Header() {
    ...
    return <>
        <div style={{
            display: "grid", gridTemplateColumns: "20% auto 18%", marginTop: "-10px", position: "fixed", marginBottom: "100px", zIndex: "100", background: "white", width: "100vw"
        }
            ...
            <h1 style={{ display: "flex" }}>
                <div>
                    <LuMenu
                        style={{ fontSize: "25px", marginRight: "20px", marginLeft: "20px", paddingTop: "12px" }} />
                </div>
                <div>
                    <svg
            ...
            <div style={{
                margin
                    : "30px 0px 0px 20px", display: "flex"
            }}>
                <div style={{}}>
                    <input
                        style={{ width: "40vw", height: "35px", border: "1px solid #d7d7dc", borderTopLeftRadius: "30px", borderBottomLeftRadius: "30px", paddingLeft: "20px" }}
                        placeholder="Search"
                    />
                </div>
                <div style={{}}>
                    <button
                        style={{ height: "39px", width: "80px", borderTopRightRadius: "30px", borderBottomRightRadius: "30px", border: "1px solid #d7d7dc" }}
                    >
                        <FaSearch
                ...
                <button
                    style={{ marginLeft: "7px", width: "40px", borderRadius: "30px", height: "39px", border: "None" }}
            ...
            <div style={{ display: "flex", marginTop: "30px" }}>
                <button
                    style={{ marginLeft: "100px", width: "40px", borderRadius: "30px", height: "39px", border: "None", background: "None" }}
                ...
                <div style={{}}>
                    {
                        loginData?.user ? <>
                            <img src={loginData?.user?.picture} width={30} height={30} />
                        </> :
                            <Link to={'/login'}>
                                <button
                                    style={{ width: "100px", height: "35px", border: "1px solid #d7d7dc", borderTopLeftRadius: "30px", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopRightRadius: "30px", background: "None" }}
