...
export default function CategoryBasedData() {
    ...
    useEffect(() => {
        fetch(`http://91.108.104.49:80/api/videos/category/${categoryType}`, { method: "GET" })
            .then((res) => {
                return res.json()
            })
            .then((data) => {
                    ...
                    >
                        ...
                        >
                            <video
                                ...
                                // src="http://91.108.104.49:80/uploads/your-video-file.mp4" // ✅ replace with your actual video URL
