...
export default function CategoryBasedData() {
    ...
    useEffect(() => {
        fetch(`http://localhost:3001/api/videos/category/${categoryType}`, { method: "GET" })
            .then((res) => {
                return res.json()
            })
            .then((data) => {
                    ...
                    >
                        ...
                        >
                            <video
                                ...
                                // src="http://localhost:3001/uploads/your-video-file.mp4" // ✅ replace with your actual video URL
